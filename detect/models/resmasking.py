...
def resmasking(in_channels, num_classes, weight_path="./checkpoint/resmasking_rot30_2019Nov14_04.38"):
    model = ResMasking(weight_path)
    model.fc = nn.Linear(512, num_classes)
    return model


def resmasking50(in_channels, num_classes, weight_path=""):
...
def resmasking_dropout1(in_channels=3, num_classes=4, weight_path=""):
    model = ResMasking(weight_path)
